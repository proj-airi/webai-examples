...
.form_input-range {
  ...
  --thumb-background: rgb(225, 225, 225);
  --thumb-background-hover: rgb(225, 225, 225);
  --thumb-background-active: rgb(225, 225, 225);

  --track-height: calc(var(--height) - var(--track-value-padding) * 2);
  --track-box-shadow: none;
  --track-border: solid 2px rgb(121, 121, 121);
  --track-border-radius: 6px;
  --track-background: rgba(50, 50, 50, 0.447);
  --track-background-hover: rgb(131, 131, 131);
  --track-background-active: rgb(131, 131, 131);

  --track-value-background: rgb(236, 236, 236);
  --track-value-background-hover: rgb(236, 236, 236);
  --track-value-background-active: rgb(236, 236, 236);
  --track-value-padding: 2px;
}

.dark .form_input-range {
  --thumb-background: rgb(145, 145, 145);
  --thumb-background-hover: rgb(145, 145, 145);
  --thumb-background-active: rgb(145, 145, 145);

  --track-border: solid 2px rgb(56, 56, 56);
  --track-background: rgb(20, 20, 20);
  --track-background-hover: rgb(20, 20, 20);
  --track-background-active: rgb(20, 20, 20);

  --track-value-background: rgb(96, 96, 96);
  --track-value-background-hover: rgb(96, 96, 96);
  --track-value-background-active: rgb(96, 96, 96);
}
