# Start contributing to [`proj-airi/webai-examples`](https://github.com/proj-airi/webai-examples)
...
Click on the **Fork** button on the top right corner of the [`proj-airi/webai-examples`](https://github.com/proj-airi/webai-examples) page.

## Clone

```shell
git clone https://github.com/<your-github-username>/webai-examples.git
cd airi
```
...
>
> ```shell
> git remote add upstream https://github.com/proj-airi/webai-examples.git
> ```

## Creating Pull Request

Navigate to [`proj-airi/webai-examples`](https://github.com/`proj-airi/webai-examples`) page, click on the **Pull requests** tab, and click on the **New pull request** button, click on the **Compare across forks** link, and select your fork repository.
